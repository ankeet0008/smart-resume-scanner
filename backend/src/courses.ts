import type { Course, RecommendedField } from './types'
...
export const androidCourse: Course[] = [
...
export const uiuxCourse: Course[] = [
...
export const resumeVideos: string[] = [
  ...
  'https://youtu.be/GyjzOKdaioU',
  'https://youtu.be/17YZBH_qtmg',
  'https://youtu.be/C7pNLIq3kOI',
  'https://youtu.be/xpaz7nrNmXA',
  'https://youtu.be/aKjsy-b00QM',
  'https://youtu.be/ciIkiWwZnlc'
]

export const interviewVideos: string[] = [
  ...
  'https://youtu.be/IBjM-F56qS0',
  'https://youtu.be/IBjM-F56qS0',
  'https://youtu.be/4tYoVx0QoN0',
  'https://youtu.be/Ge0Udbws1kc',
  'https://youtu.be/thkuu_FWFD8',
  'https://youtu.be/e0E6-dRPcJA',
  'https://youtu.be/htT1bhFSNxo',
  'https://youtu.be/TZ3C_syg9Ow'
]

export const fieldCourseMap: Record<RecommendedField, Course[]> = {
  'Data Science': dsCourse,
  'Web Development': webCourse,
  'Android Development': androidCourse,
  'IOS Development': iosCourse,
  'UI-UX Development': uiuxCourse,
  NA: []
}
